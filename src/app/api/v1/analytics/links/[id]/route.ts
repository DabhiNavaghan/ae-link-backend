...
const logger = Logger.child({ route: 'analytics-links' });
...
export async function GET(
  ...
  try {
    ...
    const analytics = await AnalyticsService.getLinkAnalytics(params.id);
    ...
    logger.error({ error: String(error) }, 'Get link analytics error');
    const errorRes = new NextResponse(
